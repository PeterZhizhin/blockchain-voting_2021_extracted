            ...
            <div class="col-xl-10 col-sm-12 bulletin__page">
                ...
                <div class="row">
                    <div class="col-sm-12 bulletin__header">
                        ...
                        <h2 class="mt-0">Какой приоритет развития городской инфраструктуры вы бы выбрали в отрасли транспорта?</h2>
                ...
                <div class="row">
                    <div class="col-sm-12 bulletin__text">
                        ...
                        <div class="font-weight-bold">
                            ...
                            Поставьте отметку в квадрате справа от варианта ответа.
                            <br />
