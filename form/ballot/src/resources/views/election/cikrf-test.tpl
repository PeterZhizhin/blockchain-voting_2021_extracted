<!DOCTYPE html>
<html>
{include file="$template_path/_header.tpl" title="Тестовое дистанционное электронное голосование"}
                ...
                <div class="row">
                    <div class="col-sm-12 bulletin__header">
                        ...
                        <h2 style="text-transform: uppercase;">
                            {if $settings.is_test}ТЕСТОВОЕ {/if}{if !empty($settings.title)}{$settings.title}{else}ДИСТАНЦИОННОЕ ЭЛЕКТРОННОЕ ГОЛОСОВАНИЕ{/if}
                        </h2>
