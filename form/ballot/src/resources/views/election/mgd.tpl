                ...
                <div class="row">
                    <div class="col-sm-12 bulletin__header">
                        ...
                        <h3>
                            ...
                            Тренировка. Дополнительные выборы</br>
                    ...
                    <div class="col-sm-12 bulletin__text" style="text-align: left">
                        <div class="font-desc">
                            {if !empty($ballot.rules)}{$ballot.rules}{else}
                                <i>Поставьте любой знак в пустом квадрате справа от фамилии только одного зарегистрированного кандидата, в пользу которого сделан выбор.</br>
                                    Избирательный бюллетень, в котором любой знак (знаки) проставлен (проставлены) более чем в одном квадрате либо не проставлен ни в одном из них, считается недействительным.</br>
                                    Избирательный бюллетень, изготовленный неофициально, либо не заверенный подписями двух членов избирательной комиссии с правом решающего голоса и (или) печатью избирательной комиссии, признается бюллетенем неустановленной формы и при подсчете голосов не учитывается.</i>
                            {/if}
                        </div>
                    </div>
                </div>
