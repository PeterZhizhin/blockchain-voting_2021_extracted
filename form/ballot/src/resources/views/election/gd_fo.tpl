...
<script type="text/javascript" src="{$CFG_JS_HOST}/js/forms/mgik/resizeGdFo.js?{$smarty.now|date_format:'%Y-%m-%dT%H'}"></script>
                                ...
                                <div class="col-sm-12 ">
                                    ...
                                    <div class="bulletin__desc row">
                                        ...
                                        <div class="col-sm-3 img_container">
                                            <img class="dep_photo" src="{$CFG_MEDIA_HOST}/images/gd_fo/{$deputy.photo}" />
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="bulletin__name">
                                                <div class="bulletin__fullname part">{$deputy.last_name}</div>
                                                <div class="bulletin__fullname desc_part">{$deputy.desc}</div>
                                                </br>
                                                <div class="bulletin__fullname reg">{$deputy.first_name}</div>
                                                <div class="bulletin__fullname desc_reg">{$deputy.descFull}</div>
                                            </div>
                                        </div>
                                    </div>
