<!DOCTYPE html>
<html>
{include file="$template_path/_header.tpl" title="Дистанционное электронное голосование по вопросу строительства метро в городе Троицке"}
            ...
            <div class="col-xl-10 col-sm-12 bulletin__page">
                ...
                <div class="row">
                    <div class="col-sm-12 bulletin__header">
                        <h1>Бюллетень{if $test} тестовый{/if}</h1>

                        <h2>
                            ДИСТАНЦИОННОГО ЭЛЕКТРОННОГО ГОЛОСОВАНИЯ ПО ВОПРОСУ:<br />
                            ГДЕ НЕОБХОДИМО РАЗМЕСТИТЬ КОНЕЧНУЮ СТАНЦИЮ МЕТРО?
                        </h2>

                        <div class="bulletin__date">
                            15-16 декабря 2019 года
                        </div>

                        <h2 class="mb-0">ГОРОДСКОЙ ОКРУГ ТРОИЦК</h2>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12 bulletin__text">
                        ...
                        <div class="font-weight-bold">
                            ...
                            Поставьте отметку в квадрате справа от варианта, который Вы поддерживаете.
