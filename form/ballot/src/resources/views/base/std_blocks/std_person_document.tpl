{if $mosDesign}
    {include file="$base_template_path/std_mos/std_person_document.tpl"}
{else}
	...
	{if $docTypeList == 'full'}
			...
			<input type="hidden" class="file_label" name="field[{$contact}.documentkind_title]" value="{$document_types.0}">
		...
		{else}
			...
			<input type="hidden" class="file_label" name="field[{$contact}.documentkind_title]" value="Паспорт гражданина РФ">
                        <div class="document-type-container document-type-other">
