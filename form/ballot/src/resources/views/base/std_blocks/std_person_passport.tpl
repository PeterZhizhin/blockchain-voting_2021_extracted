{if $mosDesign}
    {include file="$base_template_path/std_mos/std_person_passport.tpl"}
{else}
	...
	{if $document}
		...
		{else}
			...
			{/if}
		{/if}
        {elseif $document_kind||$document_send_index}
            	{if isset($document_kind)&&$document_kind}
                    <input type="hidden" name="field[{$contact}.documentkind]" value="{$document_kind}"/>
                {/if}
                {if isset($send_index)&&$send_index}
                    <input type="hidden" name="field[{$contact}.index]" value="{$document_index}"/>
                {/if}
	{/if}
{/if}